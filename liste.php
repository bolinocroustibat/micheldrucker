...
<body onload='$(".project-wrapper").css("visibility", "visible");'>
	...
	<div id="main-wrapper">
		...
		<h1>Le générateur de<div class="big_h1">fake news</div>
		</h1>
		...
		<div id="pages">
			...
			if ($page > 1) {
				echo '<a href="liste.html?page=' . ($page - 1) . '">rumeurs suivantes</a> - ';
			}
			if ($page < $total_pages) {
				echo '<a href="liste.html?page=' . ($page + 1) . '">rumeurs précédentes</a>';
			}
			?>
		</div>
